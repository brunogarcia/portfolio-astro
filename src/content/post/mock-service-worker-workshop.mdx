...
title: "Workshop about Mock Service Worker"
description: "This is a workshop I made on Wallbox about Mock Service Worker."
tags: ["workshop", "msw"]
---

I made this workshop after using [Mock Service Worker](https://mswjs.io/) on a project.
I wanted to share my experience with the team and also to have a reference for the future.

## What is Mock Service Worker?

[Mock Service Worker](https://mswjs.io/) is a library that allows you to mock the API responses.
